...
- **Schema installation:** done directly via Supabase SQL editor, in dependency order. The canonical install file is `recipe_db_install_v3.sql` (single paste, includes role grants).
