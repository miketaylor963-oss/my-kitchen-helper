...
- `app_writer` links `auth.users.id` to a household and optionally to a `person`. Writers are added by manual database operation, not self-serve signup.
...
## 10. What's NOT in the schema (yet)
